...
export interface WorkflowAPI {
    workflows: {
        ...
        update: (id: string, updates: Partial<Omit<WorkflowDefinition, "id" | "createdAt">>) => Promise<WorkflowDefinition | null>;
    ...
    hooks: {
        ...
        update: (id: string, updates: Partial<Omit<HookModule, "id">>) => Promise<HookModule | null>;
        delete: (id: string) => Promise<boolean>;
        execute: (id: string, context: any) => Promise<any>;
        import: (module: Omit<HookModule, "id">) => Promise<HookModule>;
        validate: (script: string) => Promise<{
            valid: boolean;
            error?: string;
        }>;
    };
